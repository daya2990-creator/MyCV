    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center gap-6">
              <Link href="/login" className="text-slate-600 hover:text-slate-900 font-medium text-sm">Log in</Link>
              <Link href="/signup" className="bg-slate-900 text-white px-5 py-2.5 rounded-full font-medium text-sm hover:bg-slate-800 transition-colors">Get Started</Link>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
               ...
               <div key={i} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                  <div className="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600 mb-6"><f.icon size={24} /></div>
                  <h3 className="text-xl font-bold mb-3">{f.title}</h3><p className="text-slate-500 leading-relaxed">{f.desc}</p>
               </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="border-2 border-indigo-600 rounded-3xl p-8 relative bg-slate-900 text-white shadow-2xl transform scale-105">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest">Recommended</div>
              <h3 className="text-lg font-bold text-indigo-300">Standard</h3>
              <div className="my-4 flex items-baseline gap-1"><span className="text-5xl font-black">₹39</span><span className="text-slate-400 text-sm">/ download</span></div>
            ...
            <div className="border border-slate-200 rounded-3xl p-8 hover:border-indigo-200 transition-colors">
              ...
              <div className="my-4 flex items-baseline gap-1"><span className="text-4xl font-black">₹199</span><span className="text-slate-500">/ month</span></div>
              <p className="text-sm text-slate-500 mb-6">For serious job seekers.</p>
              <ul className="space-y-3 mb-8 text-sm text-slate-600 font-medium">
                <li className="flex gap-3"><CheckCircle2 size={18} className="text-green-500"/> Unlimited Clean Downloads</li>
      ...
      <footer className="bg-slate-50 py-12 border-t border-slate-200">
         <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-4"><AppLogo size={24} textClassName="text-slate-700"/></div>
            <p className="text-slate-500 text-sm mb-8">© 2024 MyCV.guru. Helping you land your dream job.</p>
            <div className="flex justify-center gap-6 text-sm text-slate-500 font-medium"><Link href="/terms" className="hover:text-indigo-600 transition-colors">Terms of Service</Link><Link href="/privacy" className="hover:text-indigo-600 transition-colors">Privacy Policy</Link><Link href="/support" className="hover:text-indigo-600 transition-colors">Support</Link></div>
         </div>
      </footer>
    </div>
  )
